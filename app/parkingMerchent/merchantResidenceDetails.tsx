...
export default function MerchantResidenceDetails() {
  ...
  const parseZones = (): Zone[] => {
    ...
    return [{ id: '1', name: 'Building A', slots: '20', price: '50.00' }];
  };
  ...
  const [formData, setFormData] = useState({
    title: (params.title as string) || 'Residence Name',
    location: (params.location as string) || (params.address as string) || 'Location not provided',
    price: (params.price as string) || '50.00',
    description: (params.description as string) || "Residential parking facility with secure access.",
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.card}>
            <View style={styles.cardHeader}>
              ...
              <View style={{ flex: 1 }}>
                <Text style={styles.labelSmall}>Residence Name</Text>
                <EditableText 
            ...
            <View style={styles.infoBlock}>
              <Text style={styles.labelSmall}>Base Price per Month</Text>
          ...
          <View style={styles.card}>
            <Text style={styles.cardTitle}>About Residence</Text>
            <EditableText 
          ...
          <View style={styles.card}>
            <View style={styles.sectionHeader}>
              <Text style={styles.cardTitle}>Parking Buildings & Spaces</Text>
                  ...
                  <>
                    ...
                    <View style={styles.zoneDisplayRow}>
                      ...
                      <View style={styles.zoneItem}>
                        ...
                        <Text style={styles.zoneValue}>${zone.price}/month</Text>
                      </View>
                    </View>
                  </>
                )}
